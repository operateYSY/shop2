...
<body>
	...
	<div class="header">
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					...
					<h1 class="navbar-brand"><a href="index">水果商城</a></h1>
				</div>
				<!--navbar-header-->
		...
		<%-- 				<li><a href="top?typeid=2" <c:if test="${flag==7}">class="active"</c:if>>热门</a></li>
						...
						<li><a href="../admin.jsp" target="_blank">后台登陆</a></li>
			...
			<div class="header-info">
				...
				<div class="header-right login">
					<a href="infomation"><span class="glyphicon glyphicon-user" aria-hidden="true">${sessionScope.user.username}</span></a>
				</div>
